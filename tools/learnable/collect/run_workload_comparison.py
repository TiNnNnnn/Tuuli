...
from tools.learnable.common.paths import PGORCA_ROOT, TEST_ASSETS, source_file
from tools.learnable.common.artifacts import artifact_snapshot, read_snapshot
...
from tools.learnable.trace.build_xform_replacement_inventory import merge_inventory, read_matrices
from tools.learnable.collect.run_dphyper_stability import parse_dphyper_events
...
def collection_descriptor(args, query_selection, semantic_xforms):
    ...
    from tools.learnable.experiments.calibrate_rule_dro import contract_identity
...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="pgorca-workloads.", dir="/tmp") as temporary:
        ...
        if args.dro_contract or args.dro_describe:
            from tools.learnable.experiments.calibrate_rule_dro import bind_collection
