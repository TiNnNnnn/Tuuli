...
from tools.learnable.common.paths import PGORCA_ROOT, TEST_ASSETS
...
def main():
    ...
    for n in manifest['execution_order']:
        ...
        command = [sys.executable, str(PGORCA_ROOT / 'tools/learnable'), 'compare-workload', '--pg-config', args.pg_config,
