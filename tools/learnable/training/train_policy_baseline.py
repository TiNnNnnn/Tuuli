...
from tools.learnable.objectives.policy import objective_channels, selection_metrics, policy_target
from tools.learnable.data.admission import history_training_gate, assigned_history_queries
from tools.learnable.encoding.rule_history_encoding import reuse_history
...
from tools.learnable.data.export_policy_learning_samples import export_comparison
from tools.learnable.common.artifacts import read_snapshot
from tools.learnable.common.paths import package_sources
from tools.learnable.data.export_history_corpus import iter_history_runs
from tools.learnable.encoding.rule_policy_encoding import input_sequences, encode_sequence, fit_vocabulary
from tools.learnable.common.artifacts import artifact_snapshot
...
def main():
    ...
    import torch
    from tools.learnable.models.rule_policy_model import WholePolicyPredictor
