...
from tools.learnable.encoding.group_expression_encoding import attempt_samples, group_expression_sequence, stats_timeline
...
class GroupExpressionEncodingTest(unittest.TestCase):
    ...
    def test_statistics_timeline_distinguishes_prior_future_and_reset(self):
        ...
        with patch('tools.learnable.encoding.group_expression_encoding.candidate_evidence', return_value=audit):
