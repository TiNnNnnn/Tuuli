...
class SequenceEncoderTest(unittest.TestCase):
    def query_features(self, sql='SELECT a.id FROM a', catalog=None, vocabulary=None):
        from tools.learnable.tests.test_rule_policy_encoding import catalog_fixture
        from tools.learnable.encoding.rule_policy_encoding import catalog_sequences
    ...
    def setUp(self):
        from tools.learnable.models.rule_policy_model import SharedSequenceEncoder
    ...
    def test_rule_attempt_fuses_local_context_with_shared_parameters(self):
        from tools.learnable.models.rule_policy_model import RuleAttemptEncoder
        from tools.learnable.encoding.group_expression_encoding import group_expression_sequence
    ...
    def test_query_metadata_context_is_bound_per_source_and_identity_invariant(self):
        from tools.learnable.models.rule_policy_model import query_context_embedding, SharedSequenceEncoder
    ...
    def test_directed_messages_match_reference_and_are_one_step(self):
        from tools.learnable.models.rule_policy_model import DirectedRuleAggregation
    ...
    def test_query_metadata_gradients_and_rule_fusion_share_the_encoder(self):
        from tools.learnable.models.rule_policy_model import query_context_embedding, RuleAttemptEncoder
        features, vocabulary, _ = self.query_features()
