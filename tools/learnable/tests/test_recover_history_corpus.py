...
from tools.learnable.data.recover_history_corpus import check_artifacts, decode, main, publish
...
class RecoveryTest(unittest.TestCase):
    ...
    def test_deferred_failure_retains_status_without_fabricating_attempt_counts(self):
        with tempfile.TemporaryDirectory() as directory:
            ...
            with patch('tools.learnable.data.recover_history_corpus.trace_run', side_effect=AssertionError('must defer')):
