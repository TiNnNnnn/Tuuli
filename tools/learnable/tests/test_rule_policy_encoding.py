...
from tools.learnable.encoding.rule_policy_encoding import (catalog_sequences, encode_sequence, fit_vocabulary,
...
class EncodingTest(unittest.TestCase):
    ...
    def test_full_adapter_ignores_response_fields_and_preserves_positions(self):
        ...
        with patch('tools.learnable.encoding.rule_policy_encoding.read_snapshot', side_effect=read):
